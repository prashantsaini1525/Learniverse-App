...
const Header = () => {
  ...
  return (
    ...
    >
      <div className="max-w-screen-xl mx-auto px-8 flex justify-between items-center py-4">
        <div>
          <Link href="/">
          ...
          {navItems.map(({ href, text }) => (
            <Link
              ...
              className={`relative group ${
                router.pathname === href ? "text-blue-600 dark:text-blue-400" : "text-gray-900 dark:text-white"
              }`}
            >
        ...
        <div className="flex items-center space-x-4">
          <div className="hidden md:flex space-x-3">
            ...
            <Link
              href="/signup"
              className="px-5 py-2 border border-blue-600 text-blue-600 rounded-md hover:bg-blue-600 hover:text-white transition"
            >
              Sign Up
            </Link>
          </div>
